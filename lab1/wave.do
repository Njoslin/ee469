...
add wave -noupdate -radix unsigned /regstim/RegWrite
add wave -noupdate -radix unsigned /regstim/clk
add wave -noupdate -radix unsigned /regstim/ReadData1
add wave -noupdate -radix unsigned /regstim/ReadData2
add wave -noupdate -radix unsigned /regstim/i
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {352101266 ps} 0}
...
update
WaveRestoreZoom {261231200 ps} {392303200 ps}
